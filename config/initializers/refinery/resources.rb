...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "251eac813ac974c5242ddf70a37c661f0d574d244d773a56"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/Users/SchuKnight/code/ruby/rails/refinery/libs-karate-site/public/system/refinery/resources"

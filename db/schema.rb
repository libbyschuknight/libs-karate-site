...
ActiveRecord::Schema.define(version: 20180125020015) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "katas_stances", force: :cascade do |t|
    t.integer  "kata_id"
    t.integer  "stance_id"
  ...
  create_table "refinery_grades", force: :cascade do |t|
    t.string   "title"
    t.boolean  "dan"
    t.boolean  "kyu"
    t.integer  "level"
  ...
  create_table "refinery_katas", force: :cascade do |t|
    t.string   "title"
    t.text     "meaning"
  ...
  create_table "refinery_people", force: :cascade do |t|
    t.string   "first_name"
    t.string   "last_name"
    t.integer  "photo_id"
    t.string   "dojo"
  ...
  create_table "refinery_stances", force: :cascade do |t|
    t.string   "japanese_name"
    t.string   "english_name"
    t.text     "description"
    t.integer  "photo_id"
